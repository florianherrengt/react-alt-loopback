...
var CollectionsActions = (function () {
    function CollectionsActions() {
        ...
        // 'loadCollections',
        'loadCollectionsFailure', 'loadCollectionsSuccess');
    }
    ...
    _createClass(CollectionsActions, [{
        ...
        key: 'loadCollectionsSuccess',
        value: function loadCollectionsSuccess() {}
    }, {
        key: 'loadCollectionsFailure',
        value: function loadCollectionsFailure() {}
    }]);
...
var CollectionFlux = (function (_Alt) {
    ...
    function CollectionFlux() {
        ...
        console.log('flux');
        console.log('CollectionsActions', _actions2['default']);
        console.log('CollectionsStore', _store2['default']);
...
_react2['default'].render(_collectionsView2['default'], { flux: new _collectionsFlux2['default']() }, document.querySelector('body'));
